    ...
    def selection_event(self):
        ...
        for individual in self.__population:
            ...
            if picker < individual.survival_probability:
                #print(individual,'ha sobrevivido')
                self.__survivors_per_generation.append(individual)
            #else:
                #print(individual,'ha muerto')
...
def simulator_main():
    ...
    p = Simulation(population_size, generations, lifespan, emigration, inmigration, inmigration_genotype, model, reproduction, selection_group_size, survival_range, altruism_cost_benefit, altruism_probability)
