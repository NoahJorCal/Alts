...
### Individual object of simulator.py with single_gene_green_beard model (sggb) ###
''' Letter code of test fixtures' names
sggb: single_gene_green_beard
s: selfish
a: altruistic
n: nonbeard
b: beard
...
def test_generate_phenotype_sd_sggb(base_general_configuration, sd_model_configuration, genotype, expected_phenotype):
...
def test_generate_phenotype_ad_sggb(base_general_configuration, ad_model_configuration, genotype, expected_phenotype):
...
def test_generate_phenotype_c_sggb(base_general_configuration, c_model_configuration, genotype, expected_phenotype):
...
def test_age_individual_sggb(sd_model_configuration):
